            ...
            <div class="row">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="ft-newslatter">
                        ...
                        <?php echo $__env->make('frontend.partials.newsletter-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <li>
                            ...
                            <div id="modal0"class="modal0">
                                <div class="sadrzajModala0">
                                    ...
                                    <figure id="autorImg">
                                        <img src="<?php echo e(asset('assets/img/autor.png')); ?>" alt="autor"/>
                                    </figure>
...
<?php /**PATH C:\Users\HS\Desktop\sona-hotel-reservation-system\resources\views/frontend/fixed/footer.blade.php ENDPATH**/ ?>